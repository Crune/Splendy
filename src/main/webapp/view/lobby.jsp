...
<head>
    ...
    <link rel='stylesheet' href='/css/lobby/rank.css'>
        ...
        <div class="col-md-4 chat_frame" style="height: 100%">
            <div class="chat_msg_frame" id="chatDiv">
                <c:forEach begin="0" end="0">
                    <div class="chat_msg">
                        <span class="nick_o">손님4885:</span> 이게 대체 뭠미? <span class="msg_time">- 16:52</span>
                    </div>
                    <div class="chat_msg">
                        <span class="nick_o">손님4885:</span> 이거 망겜인듯 <span class="msg_time">- 16:53</span>
                    </div>
                    <div class="chat_msg">
                        <span class="nick_me">최윤일지도모릅:</span> 개객끼야! <span class="msg_time">- 16:54</span>
                    </div>
                </c:forEach>
            </div>
