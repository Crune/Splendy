...
$(document).ready(
		function() {
			...
			gameSock = new SockJS("http://" + window.location.host
					+ "/gameMain");
			...
			gameSock.onopen = function() {
				...
				for ( var i in players) {
					console.log(players[i].getUserId() + " turn status : "
							+ players[i].getTurn());
				}
